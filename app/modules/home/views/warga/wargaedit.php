...
<form role="form" action="<?php echo site_url('home/master/warga/update');?>" method="POST">
    ...
    <input type="text" class="form-control" placeholder="NIK" name="nik" onkeypress="return angka(event)" required="" value="<?php echo $warga->nik?>" maxlength="16">
                    </div>
...
<input type="text" class="form-control" placeholder="Nama" name="nama" onkeyup="this.value = this.value.toUpperCase()" value="<?php echo $warga->nama?>" autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <?php if ($warga->jk=="Perempuan"): ?>
                      <input type="radio" class="minimal" name="jk" value="Perempuan" checked>
                      Perempuan
                    <?php else: ?>
  ...
  <input type="text" class="form-control" placeholder="Tempat Lahir" name="tempatlahir" onkeyup="this.value = this.value.toUpperCase()" value="<?php echo $warga->tempatlahir?>" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal Lahir</label>
  <input type="text" class="form-control" placeholder="Tanggal Lahir" name="ttl" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask id="datemask" required="" autocomplete="off" value="<?php echo $warga->tanggallahir?>">
                    </div>
                    <div class="form-group">
...
<option value="<?php echo $warga->status_kawin?>"><?php echo $warga->nama_kawin?></option>
    ...
    <option value="<?php echo $key->id?>"><?php echo $key->nama_kawin?></option>
                ...
                <option value="<?php echo $warga->warganegara_id?>"><?php echo $warga->nama_wn?></option>
                    ...
                    <input type="text" class="form-control" value="<?php echo $warga->nama_ayah ?>" name="namaayah" onkeyup="this.value = this.value.toUpperCase()" required="" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Ibu</label>
<input type="text" class="form-control" value="<?php echo $warga->nama_ibu ?>" name="namaibu" onkeyup="this.value = this.value.toUpperCase()" required="" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">NIK Ayah</label>
                  <input type="text" class="form-control" value="<?php echo $warga->nik_ayah ?>" name="nikayah" onkeypress="return angka(event)" required="" autocomplete="off" maxlength="16">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">NIK Ibu</label>
                  <input type="text" class="form-control" value="<?php echo $warga->nik_ibu ?>" name="nikibu" onkeypress="return angka(event)" required="" autocomplete="off" maxlength="16">
                    </div>
                    <div class="form-group">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" placeholder="Alamat Sebelumnya" name="alamatsebelumnya" onkeyup="this.value = this.value.toUpperCase()" required="" autocomplete="off"><?php echo $warga->alamat_sebelumnya?></textarea>

                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Alamat Sekarang</label>
                      <textarea class="form-control" placeholder="Alamat Sekarang" name="alamatsekarang" onkeyup="this.value = this.value.toUpperCase()" required="" autocomplete="off"><?php echo $warga->alamat_sekarang?></textarea>

                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Telphone</label>
                    <input type="text" class="form-control" value="<?php echo $warga->telepon?>" name="tlp" onkeypress="return angka(event)" required="" autocomplete="off" maxlength="16">
                    </div>
                    <div class="form-group">
